...
% Define knn model 1
M_1=fitcknn(x,t,'BreakTies','smallest','Distance','euclidean','DistanceWeight','equal','NumNeighbors',10);
...
msg1 = sprintf("Results for KNN Model 1");
str1 = sprintf('%s  %.2f \n',results_M1{:});
...
% Define knn model 2
M_2=fitcknn(x,t,'BreakTies','random','Distance','seuclidean','DistanceWeight','inverse','NumNeighbors',50);
...
msg2 = sprintf("Results for KNN Model 2");
str2 = sprintf('%s  %.2f \n',results_M2{:});
%Display results on command window
disp(msg2);
disp(str2);