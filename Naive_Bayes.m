...
% Define naive bayes model 1
M_1 = fitcnb(x, t,'DistributionNames','kernel','Kernel','normal','Support','unbounded');
...
msg1 = sprintf("Results for NaiveBayes Model 1");
str1 = sprintf('%s  %.2f \n',results_M1{:});
...
% Define naive bayes model 1
M_2 = fitcnb(x, t,'DistributionNames','kernel','Kernel','triangle','Support','unbounded');
