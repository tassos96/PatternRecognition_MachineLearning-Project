...
% Define SVM model 1
M_1 = fitctree(x, t,'AlgorithmForCategorical','exact','MergeLeaves','on','MinParentSize',10);
...
msg1 = sprintf("Results for Decision Tree Model 1");
str1 = sprintf('%s  %.2f \n',results_M1{:});
...
% Define SVM model 2
M_2 = fitctree(x, t,'AlgorithmForCategorical','PullLeft','MergeLeaves','off','MinParentSize',40);
...
msg2 = sprintf("Results for Decision Tree Model 2");
str2 = sprintf('%s  %.2f \n',results_M2{:});
%Display results on command window
disp(msg2);
disp(str2);